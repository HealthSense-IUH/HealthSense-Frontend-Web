...
const teamMembers: TeamMember[] = [
  {
    ...
    gradient: "from-[#80091B] via-[#4A081D] to-[#1E1B4B]"
  },
  {
    id: 2,
    ...
    gradient: "from-[#1E3A8A] via-[#1E1B4B] to-[#4A081D]"
  },
  {
    id: 3,
    ...
    gradient: "from-[#0F766E] via-[#134E4A] to-[#1E1B4B]"
  },
  {
    id: 4,
    ...
    gradient: "from-[#701A75] via-[#4A044E] to-[#1E1B4B]"
  },
]
...
export function MeetOurTeamSection() {
  ...
  return (
    <section className="w-full py-24 sm:py-32 relative overflow-hidden bg-white text-slate-900 border-t border-slate-200/80">
      ...
      {/* Background Graphic Accents (Signature Guideline Style) */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-rose-500/10 via-red-500/5 to-transparent rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-blue-500/10 via-sky-500/5 to-transparent rounded-full blur-[100px] pointer-events-none" />

      {/* Abstract Ribbon Wave SVG (Inspired by Reference Graphic) */}
      <svg 
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 sm:mb-20">
          <div>
            {/* Giant Stacked Title (Signature Guideline Typography) */}
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black font-heading tracking-tight leading-[0.95] text-[#80091B] uppercase">
              MEET OUR <br />
          ...
          <div className="lg:col-span-8">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div>
                  {/* Category Indicator */}
                  <span className="text-xs font-mono font-bold tracking-widest text-rose-300 uppercase block mb-3">
                    {currentMember.badge}
                  </span>
                  ...
                  {/* Role */}
                  <p className="text-xs sm:text-sm font-bold font-heading text-rose-200/90 mb-6 uppercase tracking-wider">
                    {currentMember.role}
                  </p>

                  {/* Quote with quote icon */}
                  <div className="relative pl-6 border-l-2 border-rose-400/50 mb-6">
                    <Quote className="w-5 h-5 text-rose-400/40 absolute -left-2.5 -top-1 fill-rose-400/20" />
                    <p className="text-sm sm:text-base text-rose-50/95 italic leading-relaxed font-sans font-normal">
                ...
                <div className="pt-6 border-t border-white/15 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <p className="text-xs text-rose-100/70 font-sans max-w-lg leading-relaxed">
                    {currentMember.bio}
                  </p>
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-2xl transition-all duration-300 flex items-center gap-4 cursor-pointer border ${
                      isActive 
                        ? "bg-[#80091B] text-white border-[#80091B] shadow-lg shadow-rose-950/20 scale-[1.02]" 
                  ...
                  >
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                      ...
                      <span className={`text-xs truncate ${isActive ? "text-rose-200 font-medium" : "text-slate-500"}`}>
                        {member.role}
                      </span>
                    </div>

                    {isActive && (
                      <div className="w-2 h-2 rounded-full bg-rose-400 shrink-0 animate-ping" />
                    )}
                  </button>
                )
              })}
            ...
            <div className="flex items-center justify-between pt-2 px-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-[#80091B] hover:bg-[#600614] text-white flex items-center justify-center transition-all cursor-pointer shadow-md shadow-rose-950/20"
                >
