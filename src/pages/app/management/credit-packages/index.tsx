      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
              Quản lý gói lượt tư vấn
            </h1>
          </div>
          <p className="text-sm text-muted-foreground mt-1">
            Thiết lập danh mục gói lượt tư vấn, đơn giá VND và trạng thái mở bán toàn hệ thống.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="rounded-xl h-10 gap-2 shadow-xs"
          >
      ...
      <Card className="rounded-2xl border shadow-xs">
        <CardHeader className="pb-4 border-b">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <CardTitle className="text-lg font-bold">Danh sách gói lượt</CardTitle>
              <CardDescription className="text-xs mt-0.5">
                Tổng cộng {filteredPackages.length} gói ({packages.filter((p) => p.status === "ACTIVE").length} đang mở bán)
              </CardDescription>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full md:w-auto">
              <div className="relative w-full sm:w-64">
                ...
                <Input
                  placeholder="Tìm kiếm theo mã, tên gói..."
                  value={searchQuery}
              ...
              <div className="flex items-center gap-1.5 w-full sm:w-auto">
                ...
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className="w-full sm:w-[150px] h-9 rounded-xl text-xs">
                    <SelectValue placeholder="Trạng thái" />
                  </SelectTrigger>
                  <SelectContent className="rounded-xl text-xs">
                    <SelectItem value="ALL">Tất cả trạng thái</SelectItem>
                    <SelectItem value="ACTIVE">Đang mở bán (ACTIVE)</SelectItem>
                    <SelectItem value="INACTIVE">Tạm ẩn (INACTIVE)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/30">
                  ...
                  <TableHead className="w-[100px] text-right font-semibold text-xs">Thao tác</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
